...
export function getPrice(chainId:number) {
  ...
  switch (chainId) {
    case 1:
    case 11155111: dsChainId = 'ethereum'; break
    case 56:
    case 97: dsChainId = 'bsc'; break
    case 42161:
    case 421613: dsChainId = 'arbitrum'; break
    case 43114:
    case 43113: dsChainId = 'avalanche'; break
    case 8453:
    case 84532: dsChainId = 'base'; break
    default: dsChainId = 'ethereum'
  }
  let pair
...
export async function getDexscreener() {
  ...
  // 🐌
  const lazy = () => fetch('https://api.dexscreener.com/latest/dex/tokens/0x3419875B4D3Bca7F3FddA2dB7a476A79fD31B4fE')
