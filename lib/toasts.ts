...
// import Toast from '../../islands/bridge/Toast.tsx'
...
function createToast(
  { hash, explorer, status }: {
    hash: string;
    explorer: { name: string; url: string };
    status: Signal<"0x1" | "0x0" | null>;
  },
) {
  // const id = Symbol()
  // const onClose = () => {
...
const toasts = new Signal<
  { component: ReturnType<typeof Toast>; id: symbol }[]
>([]);

export { createToast, toasts };
