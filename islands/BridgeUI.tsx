...
function truncate(adrs: string) {
      ...
      let message = firstadrs.concat("...", lastadrs);
      return(message);
  }
        ...
        <div>
            ...
            {state.value.addresses?.at(0) && ( 
                ...
                <div class="flex gap-2 mb-5">
                    ...
                    <input class="py-2 text-center w-[4rem] rounded-lg text-center" onInput={onDestinationInput} list="chains" placeholder={'chain'}></input>
                </div>
            ...
            {state.value.addresses?.at(0)==null &&(  /* renders placeholder when no wallet connected */
                ...
                <Web3Input style={{ opacity: 0.7, pointerEvents: 'none' }} placeholder="amount"></Web3Input>
                ...
                <div class="flex gap-2 mb-5">
                    ...
                    <div class="font-[Poppins] font-medium my-auto">on</div>
                    <input style={{ opacity: 0.5, pointerEvents: 'none' }} class="py-2 text-center w-[4rem] rounded-lg text-center" list="chains" placeholder={'chain'}></input>
                </div>
