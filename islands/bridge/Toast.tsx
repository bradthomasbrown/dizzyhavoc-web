...
export default function Toast(
  ...
  return (
    <div
      class="flex items-center shadow-lg sm:mx-auto mx-0 justify-between w-full max-w-sm min-w-80 p-4 text-[#212121] bg-white rounded-lg dark:text-white dark:bg-[#212121]"
      role="alert"
    >
      ...
      <div class="flex flex-col mr-1">
        <div class="ms-3 text-sm font-[monospace] font-bold">
          Sending transaction to chain.
        </div>
        <div class="ms-3 text-sm font-[monospace]">
          Bridge - Etherscan -{" "}
          <a href="0x123...abc">
            {props.hash.slice(0, 5)}...{props.hash.slice(-3)}
          </a>
        </div>
      </div>
      <button
        ...
        type="button"
        class=" bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-[#303030] dark:hover:bg-[#414141]"
