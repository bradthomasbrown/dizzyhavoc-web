          ...
          <div className="bg-white dark:bg-[#191919] h-[400px] p-6 rounded max-w-lg mx-auto">
            ...
            <div className="mt-4 text-gray-800 dark:text-[#d2d2d2] text-base leading-6">
              <ul className="list-disc ml-8">
                <li>
                  Being blessed by the DizzyHavoc team{" "}
            ...
            <div className="mt-4">
              <label className="inline-flex items-center">
                ...
                />
                <span className="ml-2 text-gray-800 dark:text-[#d2d2d2]">
            ...
            <div className="mt-6 flex justify-end">
              <div
                ...
                className={`text-2xl mx-auto shadow-xl font-[Poppins] text-gray-800 dark:text-[#d2d2d2] rounded-lg py-1 px-4 hover:scale-[102%] border dark:border-[#3d3d3d] border-[#e9e9e9] dark:bg-[#191919] cursor-pointer bg-[#f1f1f1] ${
                  displayPopUp ? "" : "opacity-50 pointer-events-none"
                }`}
                onClick={() => {
                  closePopUp();
                }}
