...
// import { state, statuses } from '../lib/utils/mod.ts'
...
//             <div class="inline-flex justify-center items-center flex-shrink-0 w-8 h-8 text-blue-500 bg-white rounded-lg dark:bg-blue-800 dark:text-blue-200">
//                 { foo }
//             </div>
//             <div class="flex flex-col mr-1">
//                 <div class="ms-3 text-sm font-[monospace] font-bold">Sending transaction to chain.</div>
//                 <div class="ms-3 text-sm font-[monospace]">Bridge - {props.explorer.name} - <a class="underline" href={`${props.explorer.url}/tx/${props.hash}`}>{abbrev}</a></div>
//             </div>
