...
export default function Home() {
  return (
    <>
      <div class="h-[80px] items-center px-4  flex bg-gradient-to-b from-[#dddddd] bg-[#cccccc]">
      ...
      <div class="w-full h-screen flex justify-center">
        <div class="flex w-full flex-col items-center mb-[5rem]">
          <h1 class="lg:text-[5rem] text-[3rem] mt-[3rem] underline font-Poppins text-[#3d3d3d]">
            DizzyHavoc - Bridge
          </h1>
          ...
          <div className="w-[30%] bg-[#d1d1d1]  shadow-xl rounded-xl flex h-[45%] mt-[5rem] items-center justify-center">
